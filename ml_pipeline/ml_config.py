...
class MLDatabaseUploader:
    ...
    def upload_model(self) -> Any:
        ...
        ml_model = MLModel.objects.create(
            ...
            version=version,
            r2_val=float(self.metrics.get('r2_val', self.metrics.get('r2', 0))),
            rmse_val=float(self.metrics.get('rmse_val', self.metrics.get('rmse', 0))),
            mae_val=float(self.metrics.get('mae_val', self.metrics.get('mae', 0))),
            mape_val=self.metrics.get('mape_val', self.metrics.get('mape')),
            medae_val=self.metrics.get('medae_val', self.metrics.get('medae')),
            me_val=self.metrics.get('me_val', self.metrics.get('me')),
            mpe_val=self.metrics.get('mpe_val', self.metrics.get('mpe')),
            r2_val_std=self.metrics.get('r2_val_std', self.metrics.get('r2_std')),
            rmse_val_std=self.metrics.get('rmse_val_std', self.metrics.get('rmse_std')),
            mae_val_std=self.metrics.get('mae_val_std', self.metrics.get('mae_std')),
            r2_train=self.metrics.get('r2_train', self.metrics.get('train_r2')),
            rmse_train=self.metrics.get('rmse_train', self.metrics.get('train_rmse')),
            mae_train=self.metrics.get('mae_train', self.metrics.get('train_mae')),
            r2_test=self.metrics.get('r2_test'),
            rmse_test=self.metrics.get('rmse_test'),
            mae_test=self.metrics.get('mae_test'),
            mape_test=self.metrics.get('mape_test'),
